    ...
    def _register_default_valves(self):
        ...
        valves = [
            ...
            ValveSpec(
                ...
                default_value='{"default_provider": "ollama", "base_url": "http://localhost:11434", "fallback_model": "llama3:8b"}',
                title="Custom Model Configuration",
                description="JSON configuration for custom models and providers. Default uses local Ollama setup.",
                category="advanced",
                advanced=True,
                required=True
            )
