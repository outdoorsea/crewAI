...
def get_http_client(user_context: Optional[Dict[str, Any]] = None) -> httpx.Client:
    """Get configured HTTP client with optional user context"""
    headers = _http_config.headers.copy()
...
class MemorySearchTool(BaseTool):
    ...
    name = "search_memory"
    description = "Search for information in memory using semantic search. Supports searching people, places, events, tasks, and general content."
...
class GetCurrentStatusTool(BaseTool):
    ...
    description = "Get the current user status including mood, activity, location, and availability"
...
class GetSelfProfileTool(BaseTool):
    """Get user self profile with user context support"""
    
    name = "get_self_profile"
    description = "Get the user's self profile including personal information, preferences, and traits. Automatically extracts user context from the current task execution."
    
    def _run(self, **kwargs) -> str:
        """Get self profile with user context"""
        try:
            ...
            with get_http_client(user_context) as client:
...
class AddFactTool(BaseTool):
    ...
    name = "add_fact"
    description = "Add a fact or piece of information to memory with optional categorization and tags"
...
class AddPreferenceTool(BaseTool):
    ...
    name = "add_preference"
    description = "Add or update a user preference based on observed behavior"
...
class UpdateStatusTool(BaseTool):
    ...
    name = "update_status"
    description = "Update the user's current status including mood, activity, location, and availability"
...
class CreateEntityTool(BaseTool):
    ...
    name = "create_entity"
    description = "Create a new entity like a person, place, group, task, or event"
...
class GetStatusHistoryTool(BaseTool):
    ...
    description = "Get user status history for a specified time period"
...
class ReflectOnMemoryTool(BaseTool):
    ...
    description = "Process reflections and generate insights from memory patterns"
...
class StoreConversationAnalysisTool(BaseTool):
    ...
    description = "Store detailed conversation analysis results for future reference and pattern detection"
...
class GetHealthMetricsTool(BaseTool):
    ...
    description = "Retrieve health metrics and wellness data"
...
class GetRecentActivityTool(BaseTool):
    ...
    description = "Get recent user activity including tasks, events, journal entries, and other interactions"
